...
SECRET_KEY = 'django-insecure-)g8h@dlr19is*fb$05g_=l@$w5d0b8bfz)!s%0p*qj69s)v!r3'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'conf/templates/home/'),os.path.join(BASE_DIR,'conf/templates/user/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'conf/static/media')
